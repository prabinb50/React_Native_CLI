...
const App = () => {
    ...
    // We can also give css using javascript object like we did in the Image component, but it is not recommended as it can make the code messy and hard to read
    const style = {
        image: {
            width: 200,
            height: 300,
    ...
    // So it is better to use StyleSheet.create method to create a stylesheet and then use it in the component
